...
keydivs.forEach((key) => {
	key.innerHTML = '<span class="key-text">' + key.getAttribute("data-note").substring(0, 1)+ '<br class="line1">' + key.getAttribute("data-oktave") + '<br class="line1">' + key.getAttribute("data-key") + '</span>';
});
