...
keydivs.forEach((key) => {
	key.innerHTML = '<span class="key-text">' + key.getAttribute("data-note").substring(0, 1)+ '<class="line1" br>' + key.getAttribute("data-oktave") + '<class="line1" br>' + key.getAttribute("data-key") + '</span>';
});
